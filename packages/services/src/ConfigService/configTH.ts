...
export const domainMapTH: DomainMap = {
...
export const configTH: IFullRegionConfig = {
	region: {
		...defaultRegionConfig,
		countryPhoneCode: "66",
		region: Region.THA,
	...
	environments: {
		[ENV.LOCAL]: {
			...
			promoEventsIFrameUrl:
				"https://con-apac-acuvue-th-th.jnjapacb15d3-test.jjc-devops.com/app/myacuvue/promo-event",
		},
		[ENV.PREDEV]: {
			baseUrl: `https://${
		...
		[ENV.PROD]: {
			...
			promoEventsIFrameUrl:
				"https://acuvue.co.th/app/myacuvue/promo-event",
		},
	},
};
