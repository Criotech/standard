...
const CrossedEyeIcon: FC<Props> = ({
	size = IconSize.MEDIUM,
	color,
}: Props) => (
	<Icon component={CrossedEyeSvg} style={{ fontSize: size, color }} />
);
